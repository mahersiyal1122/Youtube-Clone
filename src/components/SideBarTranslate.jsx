...
const SideBarTranslate = () => {
    const { sideBarVisibility,sideBarTranslateVisibility } = useContext(YtContext)

    return (
      <section id='sidebarTranslate' className={`absolute z-50 h-[calc(100vh-68px)] w-64 flex-col bg-[#0f0f0f] overflow-y-auto py-1 hidden max-[1200px]:flex ${sideBarTranslateVisibility?"translate-x-[0px]":"translate-x-[-300px]"} transition-all duration-[0.3s] `}>
